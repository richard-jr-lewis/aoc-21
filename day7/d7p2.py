...
for possible_position in range(0, max(crab_positions.keys()) + 1):
    total_fuel_for_position = sum([(get_gauss_value(abs(crab_position - possible_position)) * crab_positions[crab_position]) for crab_position in crab_positions.keys()])
